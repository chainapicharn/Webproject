...
<img src="img/skill2-1.jpg" alt="skill2-1" width="300" height="300"class="center"/>
<p>1.ยืดกล้ามเนื้อคอด้านข้างและไหล่</br>-นั่งหน้าตรง ใช้มือข้างตรงข้ามกับที่ต้องการยืดวางเหนือใบหู</br>-ดึงศีรษะมาด้านตรงข้าม</br>-ยักไหล่ค้างไว้ 15 วินาที</p> 

<img src="img/skill2-2.jpg" alt="skill2-2" width="300" height="300"class="center"/>
<p>2.ยืดกล้ามเนื้อคอและไหล่</br>-หันศีรษะไปด้านตรงกันข้ามกับด้านที่จะยืด</br>-มือด้านตรงกันข้ามจับด้านหลังของศีรษะ</br>-ดึงก้มศีรษะไปทางด้านหน้า ค้างไว้ 15 วินาที</p>

<img src="img/skill2-3.jpg" alt="skill2-3" width="300" height="300"class="center"/>
<p>3.บริหารกล้ามเนื้อบริเวณไหล่</br>-นั่งให้หลังตรง</br>-ยักไหล่สองข้างขึ้นพร้อมกัน</br>-หลังจากนั้นกดไหล่สองข้างลง</br>-ดึงสะบักลงเข้าหากัน</p>

<img src="img/skill2-4.jpg" alt="skill2-4" width="300" height="300"class="center"/>
<p>4. ยืดกล้ามเนื้ออกด้านหน้า</br>-ยืนระหว่างประตูแล้วโน้มตัวไปด้านหน้า</br>-กระทั่งรู้สึกตึงที่กล้ามเนื้อ ทำค้างไว้ 15 วินาที</p>

<img src="img/skill2-5.jpg" alt="skill2-5" width="300" height="300"class="center"/>
<p>5. ท่าบริหารกล้ามเนื้อคอชั้นลึก</br> -พยายามเกร็งกล้ามเนื้อคอเพื่อดึงคางเข้ามาด้านใน</br>-เกร็งค้างไว้ 5 วินาที แล้วผ่อนคลาย</br>-เมื่อทำได้คล่องแล้วให้ใช้ลูกบอลต้านแรงกดของคาง</p>
