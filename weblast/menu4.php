...
<body>
<p class="text11"></p>
    <h1>ท่าแก้ปวดหลังล่าง</h>
<img src="img/skill4-1.jpg" alt="skill4-1" width="300" height="300"class="center"/>
<p>1.ท่าสะพานโค้ง</br>-นอนหงาย ชันเข่าทั้งสองข้างขึ้น</br>-มือทั้งสองวางข้างลำตัว</br> -ยกตัวให้ก้นลอยพ้นพื้น เกร็งท่าค้างไว้ นับ 1-10 แล้วค่อยกลับสู่ท่าเดิม</br>ทำซ้ำประมาณ 2-3 เซต</p>

<img src="img/skill4-2.jpg" alt="skill4-2" width="300" height="300"class="center"/>
<p>2.ท่ายืนก้มตัว</br>-ยืนตรง เท้าชิดกัน ปลายเท้าขนานกับหัวไหล่</br>-ค่อยๆ ก้มตัวไปด้านหน้า เข่าตึง แล้วเหยียดแขนแตะปลายเท้า (หากแตะไม่ถึงให้ก้มมากที่สุดเท่าที่จะทำได้)</br>-ค้างท่าไว้ 10 วินาที จากนั้นกลับสู่ท่ายืนปกติ</br>-ทำซ้ำอีก 5-10 เซต</p>
